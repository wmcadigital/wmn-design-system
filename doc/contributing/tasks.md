...
- [1. Tasks](#1-tasks)
  ...
  - [1.2. Linting](#12-linting)
    - [1.2.1. Scripts (Javascript)](#121-scripts-javascript)
      - [1.2.1.1. Command](#1211-command)
      - [1.2.1.2. What it does](#1212-what-it-does)
      - [1.2.1.3. File(s) that are linted](#1213-files-that-are-linted)
      - [1.2.1.4. Config](#1214-config)
    - [1.2.2. Templates (HTML)](#122-templates-html)
      - [1.2.2.1. Command](#1221-command)
      - [1.2.2.2. What it does](#1222-what-it-does)
      - [1.2.2.3. File(s) that are linted:](#1223-files-that-are-linted)
      - [1.2.2.4. Config](#1224-config)
  - [1.3. Cleaning](#13-cleaning)
    - [1.3.0.5. Command](#1305-command)
    - [1.3.0.6. What it does](#1306-what-it-does)
  - [1.4. Building](#14-building)
    - [1.4.1. Scripts (Javascript)](#141-scripts-javascript)
      - [1.4.1.1. Command](#1411-command)
      - [1.4.1.2. What it does](#1412-what-it-does)
    - [1.4.2. Styles (Sass)](#142-styles-sass)
      - [1.4.2.1. Command](#1421-command)
      - [1.4.2.2. What it does](#1422-what-it-does)
    - [1.4.3. Templates (HTML)](#143-templates-html)
      - [1.4.3.1. Command](#1431-command)
      - [1.4.3.2. What it does](#1432-what-it-does)
    - [1.4.4. Images](#144-images)
      - [1.4.4.1. Command](#1441-command)
      - [1.4.4.2. What it does](#1442-what-it-does)
    - [1.4.5. Config](#145-config)
      - [1.4.5.1. Command](#1451-command)
      - [1.4.5.2. What it does](#1452-what-it-does)
    - [1.4.6. Build all](#146-build-all)
      - [1.4.6.1. Command](#1461-command)
      - [1.4.6.2. What it does](#1462-what-it-does)

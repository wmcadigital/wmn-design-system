...
const journeyPlannerWidgetJS = () => {
  // Constants
  const activeClass = 'tfwmds-is--active';
  ...
  const expandWidget = e => {
    e.target.closest('.tfwmds-journey-planner-widget').classList.add(openClass);
  };
  ...
  const toggleMode = e => {
    ...
    const button = e.target.tagName !== 'BUTTON' ? e.target.closest('.tfwmds-btn--mode') : e.target;
  ...
  const updateTimeOptions = (parentEl = currentWidget) => {
    const day = parentEl.querySelector(".tfwmds-fe-dropdown__select[name='day']").value;
    if (day === 'today') {
  ...
  const init = () => {
    ...
    const switchBtn = currentWidget.querySelector('.tfwmds-journey-planner-widget__switch');
    ...
    const whenController = currentWidget.querySelector(
      '.tfwmds-journey-planner-widget__when--collapsed button'
    );
    const howController = currentWidget.querySelector(
      '.tfwmds-journey-planner-widget__how--collapsed button'
    );
    ...
    const day = currentWidget.querySelector(
      '.tfwmds-journey-planner-widget__when .tfwmds-fe-dropdown__select[name="day"]'
    );
    ...
    const whenControllerButton = currentWidget.querySelector(
      '.tfwmds-journey-planner-widget__when-controller button'
    );
    ...
    const howControllerButton = currentWidget.querySelector(
      '.tfwmds-journey-planner-widget__how-controller button'
    );
    ...
    const mainTravelModeInputs = currentWidget.querySelectorAll(
      '.tfwmds-journey-planner-widget__how input[type="checkbox"]'
    );
    ...
    const altTravelModeInputs = currentWidget.querySelectorAll(
      '.tfwmds-journey-planner-widget__how input[type="radio"]'
    );
  ...
  const widgets = document.querySelectorAll('.tfwmds-journey-planner-widget');

const feedbackLoopJS = () => {
  // CONSTANTS
  const feedbackLoopClass = 'tfwmds-feedback-loop';
  const isOpenClass = 'tfwmds-is--open';
  const isSentClass = 'tfwmds-is--sent';

  const formGroupClass = 'tfwmds-fe-group';
  const formInputClass = 'tfwmds-fe-input';
  const formCheckBoxesClass = 'tfwmds-fe-checkboxes';
  const formTextareaClass = 'tfwmds-fe-textarea';
  const formGroupErrorClass = `${formGroupClass}--error`;
  const inputErrorClass = `${formInputClass}--error`;
  const errorMessageClass = 'tfwmds-fe-error-message';

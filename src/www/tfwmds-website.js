...
import cookies from '../tfwmds/patterns/cookies/cookies-manager/_example';
import headerJs from '../tfwmds/patterns/header-v2/_example';
import footerJs from '../tfwmds/patterns/footer/_example';
import accordionsJS from '../tfwmds/components/accordion/_example';
import travelUpdatesWidgetJs from '../tfwmds/patterns/travel-updates/_example';
import searchFilterJs from '../tfwmds/patterns/search/search-filter/_example';
import feedbackLoopsJS from '../tfwmds/patterns/feedback-loop/_example';
import nIcons from '../tfwmds/components/icon/n-icon/_example';
...
const icons = () => {
  ...
  ajax.open('GET', '/img/tfwmds-icons.min.svg', true);
  ajax.send();
  ajax.onload = () => {
